...
class UtilityStone(Plugin):
    ...
    commands = {
        ...
        "menu": {
            "description": "Open the UtilityStone Server Menu.",
            "usages": ["/menu [action: str]"],
            "aliases": ["usttest"],
    ...
    permissions = {
        ...
        "utilitystone.admin.inventory.edit": {"description": "Edit player inventories.", "default": "op"},
        "utilitystone.admin.players.inventory.view": {"description": "View player inventories.", "default": "op"},
        "utilitystone.admin.players.inventory.edit": {"description": "Edit player inventories.", "default": "op"},
        "utilitystone.admin.enderchest.view": {"description": "View player ender chests.", "default": "op"},
        "utilitystone.admin.enderchest.edit": {"description": "Edit player ender chests.", "default": "op"},
        "utilitystone.admin.players.enderchest.view": {"description": "View player ender chests.", "default": "op"},
        "utilitystone.admin.players.enderchest.edit": {"description": "Edit player ender chests.", "default": "op"},
